...
Help function to calculate(string). This function is responsible for performing basic arithmetic operations (addition, subtraction, multiplication, and division) on a given mathematical expression represented as an array called query. The n parameter specifies the operation to be performed (+, -, *, or /).
...
// Function to save result to memory button
function saveMemory() {
...
// Function to clear memory button
...
// Function to select and use use memory buttons
...
//function to handle level button
